...
$result = mysqli_query($con, "select DName, FORMAT(sum(Debit),2) as dddd from voucher group by Dname UNION select CName, FORMAT(sum(Credit),2) as cccc from voucher GROUP by CName") or die( mysqli_error($con));
